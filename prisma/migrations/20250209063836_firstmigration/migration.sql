...
-- CreateIndex
CREATE UNIQUE INDEX "Blog_notionPageId_key" ON "Blog"("notionPageId");
...
-- AddForeignKey
ALTER TABLE "NotionToken" ADD CONSTRAINT "NotionToken_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
